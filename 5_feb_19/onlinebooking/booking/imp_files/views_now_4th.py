...
def session_exaample(request):
    session_data = request.session.get('id', '24073008-7636-4721-bdd4-f8ef4f511c5d')
...
def passenger_page_info1(request):
    ...
    '''
    if request.method == "GET":
        if request.session.get('heading_date'):
            del request.session['heading_date']
        print request.GET
...
#     data = [[{u'first_name': u'suni'}, {u'secondname': u'swaaaaaaaaaaaaa'}, {u'passport': u'123'}], [{u'dob': u'45'}, {}, {u'first_name': u'gfg'}], [{u'passport': u'79'}, {u'nationality': u'in'}, {u'dob': u'2'}], [{u'first_name': u'rtrt'}, {u'secondname': u'uyuy'}, {}], [{u'secondname': u'kjkj'}, {}, {u'first_name': u'tyu'}], []]
