...
# my_list = [{}, {}, {}, {}, {}, {u'first_name': u'suni'}, {u'secondname': u'swain'}, {}, {u'first_name': u'anita'}, {u'secondname': u'swain'}, {}, {u'first_name': u'namita '}, {u'secondname': u'swain'}, {}, {u'first_name': u'ravi raj'}, {}, {}, {}, {}, {}]
# print len(my_list)
# n=3
...
#     [{u'first_name': u'suni'}, {u'secondname': u'swain'}, {u'passport': u'no'}], 
#     [{u'first_name': u'anitha'}, {u'secondname': u'swain'}, {u'passport': u'yes'}], 
#     [{u'first_name': u'ravi'}, {}, {u'passport': u'no'}], 
#     [{u'first_name': u'chinni'}, {}, {u'passport': u'no'}]]


# hello = [[{u'first_name': u'suni'}, {u'secondname': u'swain'}, {u'passport': u'no'}], 
# [{u'first_name': u'anitha'}, {u'secondname': u'swain'}, {u'passport': u'yes'}], 
# [{u'first_name': u'ravi'}, {}, {u'passport': u'no'}], 
# [{u'first_name': u'chinni'}, {}, {u'passport': u'no'}]]
...
#         if h.get('first_name'):
#             dic['first_name']=h['first_name']
#         else:
#             dic['first_name']=''

#         if h.get('secondname'):
#             dic['secondname']=h['secondname']
#         else:
#             dic['second_name']=''

#         if h.get('passport'):
#             dic['passport']=h['passport']
#         else:
#             dic['passport']='false'

#         if h.get('nationality'):
#             dic['nationality']=h['first_name']
#         else:
#             dic['nationality']='false'

#         # li.append(dic)

#         if h.get('dob'):
#             dic['dob']=h['first_name']
#         else:
#             dic['dob']='false'
...
# [{'first_name': '', 'dob': 'false', 'passport': u'no', 'secondname': u'swain', 'nationality': 'false', 'second_name': ''}], 
# [{'first_name': '', 'dob': 'false', 'passport': u'yes', 'secondname': u'swain', 'nationality': 'false', 'second_name': ''}],
#  [{'dob': 'false', 'nationality': 'false', 'first_name': '', 'second_name': '', 'passport': u'no'}], 
#  [{'dob': 'false', 'nationality': 'false', 'first_name': '', 'second_name': '', 'passport': u'no'}]]
...
# data = [[{u'secondname': u'swain'}, {}, {u'first_name': u'anita'}, {u'secondname': u'swain'}], [{u'first_name': u'namita '}, {u'secondname': u'swain'}, {}, {u'first_name': u'ravi raj'}], [{}, {}, {}, {}]]
...
n = 2
mylist = [{}, {}, {}, {u'first_name': u's'}, {u'secondname': u's'}, {}, {u'first_name': u'a'}, {u'secondname': u'a'}, {}, {u'first_name': u'n'}, {u'secondname': u's'}, {}, {u'first_name': u'r'}, {u'secondname': u'r'}, {}, {}, {}, {}]
newlist = mylist[2:]
# print newlist
# print len(newlist)


lst = newlist[:len(newlist)-4]
...
data = [[{}, {u'first_name': u'a'}, {u'secondname': u'a'}], [{}, {u'first_name': u'ss'}, {}], [{}, {u'first_name': u'n'}, {u'secondname': u'n'}], [{}, {u'first_name': u'aa'}, {u'secondname': u't'}]]
