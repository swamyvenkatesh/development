...
def traveller_info1(request):
    ...
    print "====================$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$"
    # [0, 1] -- [0, 1, 2] --  London All Stations - Paris - Feb. 5, 2019 == 123.70 --  Std Premier
    fare = "123.70"
...
def checkinfodeatil1(request):
    if request.method=="GET":
        ...
        products_priorities = json.loads(request.GET.get('passengers'))
        print products_priorities
        print type(products_priorities)
        print len(products_priorities)

        # print request.GET.dict()
        # <QueryDict: {u'passengers[1][first_name]': [u'suni'], u'passengers[5][first_name]': [u'nami']}>
        # <QueryDict: {u'passengers[]':'[]'}>
