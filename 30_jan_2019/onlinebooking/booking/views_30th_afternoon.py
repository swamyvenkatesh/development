...
def ticket_view(request):
    ...
    if request.session.get('child_ages'):
        ...
        child_ages = []
    # print child_ages
    # return HttpResponse(child_ages)
    ReturnReturnDate="" 
    ...
    # print xml_data
    # return HttpResponse(str(xml_data))
    ...
    if Result.status_code == 200:
        ...
        print "$$$"      
        # print response
        with open("/home/swamy/Desktop/result1.xml", "w") as dd:
        ...
        with open("/home/swamy/Desktop/result.xml", "w") as dd:
            dd.write(str(result['ACP_RailAvailRS']))

        # print result['ACP_RailAvailRS'].get('OriginDestinationOptions')
        ...
        if result['ACP_RailAvailRS'].get('OriginDestinationOptions') is not None:
            ...
            for index,i in enumerate(journey):
                ...
                # result_dict[index] = ""
                # result_dict.encode('utf-8')
                # result_dict = json.dumps(result_dict, indent=4, sort_keys=True, default=str)
            ...
            if result['ACP_RailAvailRS'].get('Fares') is not None:
                ...
                print "&&&&&&&&&"
                print result_list
                with open("/home/swamy/Desktop/result2.txt", "w") as dd:
                    dd.write(str(result_list))

                print "&&&&&&&&&"*50
                print sample 
                with open("/home/swamy/Desktop/result3.txt", "w") as dd:
                    dd.write(str(sample))
